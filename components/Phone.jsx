...
const PhoneSchedule = () => {
  const times = [
  { label: 'Ochtend', value: '08:00', active: true, tag: 'Na wakker worden' },
  { label: 'Middag', value: '14:00', active: true, tag: 'Vaste check' },
  { label: 'Avond', value: '20:00', active: true, tag: 'Voor slapengaan' }];
  ...
  return (
    <div style={{ padding: '10px 20px 0', height: '100%', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{
        ...
        letterSpacing: '-0.02em', color: 'var(--navy)', marginBottom: 4
      }}>Jouw check-in<br /><em style={{ fontStyle: 'italic', color: 'var(--coral)' }}>momenten</em></div>
      <p style={{
        fontFamily: 'var(--font-body)', fontSize: 11.5, lineHeight: 1.5,
        color: 'var(--fg-muted)', margin: '4px 0 16px'
      }}>Kies zelf wanneer <Brand /> je vraagt hoe het gaat.</p>

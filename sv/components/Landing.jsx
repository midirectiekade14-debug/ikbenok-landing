// Landing.jsx — jag är ok landing page sections (Swedish variant)
...
// ─────────────────────────────────────────────────────
// Brand mark — the jag-är-ok ring-gap "ok" button (breathing)
// ─────────────────────────────────────────────────────
  ...
  <div style={{
    ...
    <div style={{ display: 'flex', alignItems: 'center', gap: isMobile ? 0 : 36 }}>
      ...
      onMouseLeave={(e) => {e.currentTarget.style.background = 'var(--sage-deep)';e.currentTarget.style.transform = 'translateY(0)';e.currentTarget.style.boxShadow = '0 8px 18px -6px rgba(79,106,76,0.55), 0 2px 4px rgba(11,27,43,0.12), inset 0 1px 0 rgba(255,255,255,0.22), inset 0 -2px 4px rgba(0,0,0,0.14)';}}>
        {isMobile ? 'Ladda ner' : 'Ladda ner appen'}
    ...
    <div style={{ display: 'flex', justifyContent: 'center', position: 'relative' }}>
      ...
      width: 240, zIndex: 10
        ...
        <div style={{ minWidth: 0 }}>
          ...
          color: 'var(--navy)'
        }}><em style={{ fontStyle: 'italic', color: 'var(--sage-deep)' }}>Astrid</em> · 16:00</div>
        </div>
      </div>}
...
const HowItWorks = ({ intensity }) => {
  ...
  },
  {
    ...
    body: 'Svarar personen inte inom 10 minuter får anhörigvårdaren ett meddelande — med senaste kända plats och kontaktalternativ för direkt hjälp.',
      ...
      <div style={{ display: 'grid', gap: isMobile ? 56 : 80 }}>
        ...
        <div key={i} style={{
          ...
          gap: isMobile ? 32 : 80, alignItems: 'center'
            ...
            }} dangerouslySetInnerHTML={{ __html: step.title.replace(/<em>/g, '<em style="font-style:italic;color:var(--coral)">').replace(/jag är ok/g, 'jag är <em style="color:var(--coral);font-weight:600;font-style:normal">ok</em>') }} />
              <p style={{
      ...
      <div style={{ position: 'relative', maxWidth: 860 }}>
        ...
        flexWrap: 'wrap'
          ...
          <div style={{ minWidth: 0 }}>
            ...
            marginTop: 2
          }}>Anhörigvårdare · mor Astrid (82) · Stockholm</div>
          </div>
          <div style={{ flex: 1 }} />
          <div style={{
          fontFamily: 'var(--font-display)', fontStyle: 'italic',
...
<section id="pris" style={{
  ...
  position: 'relative', zIndex: 2
    ...
    textAlign: 'center'
      ...
      Vi försöker hålla ett abonnemang på <Brand /> så prisvärt som möjligt.<br />
      Avsluta när som helst — utan frågor. Du kan lägga till 5 kontakter.
    </p>
    ...
    position: 'relative', overflow: 'hidden'
      ...
      marginBottom: 32
    }}>Upp till 5 kontaktpersoner · obegränsade incheckningar</div>
      ...
      paddingTop: 24, marginBottom: 28
        ...
        {[
      'Obegränsade incheckningar per dag — välj din egen rytm',
      'Automatiskt meddelande vid tystnad — med GPS-position',
      'Veckoöversikt för anhörigvårdare',
      'Avsluta när som helst · prova gratis i 14 dagar'].
      map((f, i) =>
      <div key={i} style={{
